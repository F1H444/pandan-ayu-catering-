  ...
  return (
    <>
            ...
            {categories.map((cat, idx) => {
              ...
              return (
                <div key={cat.id} id={cat.id} className="cats__group" style={{ scrollMarginTop: '100px' }}>
                  <div className="cats__head reveal" style={{ marginBottom: cat.desc ? '0.5rem' : '2rem', textAlign: 'center' }}>
                    <h2 className="cats__title">{cat.title}</h2>
                  </div>
                  {cat.desc && (
                    <p className="cats__desc" style={{ marginBottom: '2rem', color: 'var(--c-text-2)', maxWidth: '600px', lineHeight: '1.6', margin: '0 auto 2rem auto', textAlign: 'center' }}>
                      {cat.desc}
                    </p>
                  )}
                  ...
                  {isEmpty ? (
                    <div style={{ padding: '3rem', textAlign: 'center', background: 'var(--c-bg-2)', borderRadius: 'var(--r-xl)', border: '1px dashed var(--c-border-2)', color: 'var(--c-text-3)' }}>
                      <i>Brosur / Gambar Menu belum ditambahkan. Hubungi admin untuk detail menu.</i>
                    </div>
                  ) : (
                    <>
                      {/* Dokumentasi Cover */}
      ...
      <style jsx>{`
        ...
        /* ── Brochures Grid (Flexbox Centered) ── */
        .bgrid {
          display: flex;
          flex-wrap: wrap;
